...
class WorkspaceResourceLoader:
    def __init__(self, workspace_dir: str | Path) -> None:
        ...
        primary_root = self.workspace_dir / ".codeclaw"
        legacy_root = self.workspace_dir / ".xingclaw"
        self.resource_root = legacy_root if legacy_root.exists() and not primary_root.exists() else primary_root
    ...
    def _load_settings(self) -> WorkspaceSettings:
        ...
        if prompt_cache not in {"off", "auto", "explicit"}:
            prompt_cache = None
