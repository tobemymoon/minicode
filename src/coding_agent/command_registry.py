...
def builtin_commands() -> list[RuntimeCommand]:
    return [
        ...
        RuntimeCommand(name="usage", description="查看最近一轮与累计 token/cache 用量", source="builtin"),
        ...
        RuntimeCommand(name="agents", description="查看中心化多 Agent 中的 Specialist Agent", source="builtin"),
    ]
